...
- [ ] E-02.F-03.S-03 — Unified sync/async API view per service — *sub-slice A (unified sync/async API view per service + on-read derived exposure) implemented on branch `feat/catalog-unified-api-view` (2026-07-08); verification pending, box not ticked until all blocking DoD gates green. Spec `docs/superpowers/specs/2026-07-08-catalog-unified-api-view-design.md`, plan `docs/superpowers/plans/2026-07-08-catalog-unified-api-view.md`, ledger `docs/superpowers/verification/2026-07-08-catalog-unified-api-view/dod.md`. Registry updated: `docs/design/list-filter-registry.md` (API surface panel row, all filter facets none-needed). Sub-slice B (derived service↔service `depends-on` surfaced in `/graph`) registered as follow-up, not started.*
