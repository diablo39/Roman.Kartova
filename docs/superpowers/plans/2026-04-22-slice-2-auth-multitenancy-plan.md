...
- [x] **Step 1: Infrastructure csproj**
...
- [x] **Step 2: `OrganizationDbContext`**
...
- [x] **Step 3: `OrganizationEntityTypeConfiguration`**
...
- [x] **Step 5: Generate the initial migration via EF CLI**
...
- [x] **Step 6: Add RLS SQL to the generated `Up` method**
