...
- **Per-slice review reports** for Phases 1–12 saved under `docs/superpowers/reviews/2026-05-09-feat-mstest-migration-phase-N-review.md` (local-only, dir gitignored).
