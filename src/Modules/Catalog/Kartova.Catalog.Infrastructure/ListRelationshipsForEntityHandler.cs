...
public sealed class ListRelationshipsForEntityHandler
{
        ...
        CancellationToken ct)
    {
        ...
        // Filter state the cursor is issued under (ADR-0095). Only "type" is
        // recorded here — it is the sole filter this handler currently narrows the
        // row set with under a tracked expectedFilters map. Null/absent ⇒ the
        // cursor's f-map stays empty, byte-identical to a filterless cursor.
