...
describe("registerApplicationSchema", () => {
  ...
  it("accepts empty description", () => {
    expect(registerApplicationSchema.safeParse({ ...validInput, description: "" }).success).toBe(true);
  });

  it("accepts undefined description", () => {
    expect(registerApplicationSchema.safeParse({ name: "x", displayName: "X" }).success).toBe(true);
  });
