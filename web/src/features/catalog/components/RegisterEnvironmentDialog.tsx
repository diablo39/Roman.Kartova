...
import { registerEnvironmentSchema, type RegisterEnvironmentForm } from "@/features/catalog/schemas/registerEnvironment";
        ...
        <Dialog aria-label="Register Environment" className="bg-primary rounded-xl shadow-xl p-6 outline-none">
          <div className="w-full">
            ...
            <HookForm form={form} onSubmit={onSubmit} className="space-y-5">
              <EnvironmentFormFields control={form.control} idPrefix="register-environment" disabled={mutation.isPending} />
