...
vi.mock("@scalar/api-reference-react", () => ({
  ApiReferenceReact: ({ configuration }: { configuration: { content: string; hideClientButton?: boolean } }) => {
...
describe("OpenApiRender", () => {
  it("renders Scalar read-only (hideClientButton) with the spec content on the happy path", () => {
    ...
    // Locks the read-only intent: a future edit dropping hideClientButton fails here.
