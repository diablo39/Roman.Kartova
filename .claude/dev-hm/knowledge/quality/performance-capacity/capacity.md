...
`knowledge/quality/reliability-resilience/breakers.md`. Size from arithmetic, not defaults: Little's law
...
of resources, `knowledge/quality/observability/metrics.md`) show the wall before you hit it.
